...
execute if score #aspects aspectlib.dummy matches 1.. run function aspectlib:config/_macros/dialog_type/set_input_mode_to_basic with storage aspectlib:cache temp.config
# Otherwise change to Advanced Input Mode
execute unless score #aspects aspectlib.dummy matches 1.. run function aspectlib:config/_macros/dialog_type/set_input_mode_to_advanced with storage aspectlib:cache temp.config
