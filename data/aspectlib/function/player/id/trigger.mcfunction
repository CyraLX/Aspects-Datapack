...
# Log in chat
execute if entity @p[tag=get_debug_logs] run tellraw @a[tag=get_debug_logs] [{"text":"[AspectLib]: ","color":"#7700A7"},{"selector":"@s","color":"#aaaaaa","extra":[{"text":" was assigned ID "},{"text":"#","color":"gold","extra":[{"score":{"name":"@s","objective":"aspectlib.player_id"}}]}]}]
