...
# If player_id is not set, default to -1
execute unless score @s aspectlib.player_id = @s aspectlib.player_id run return run data modify storage aspectlib:dummy id set value -1
