...
# Open Aspect Picking dialog to players and make them Invisible/Resistant
execute as @a[predicate=aspects:dialog/choose_menu/choose_menu_open] at @s run function aspects:dialog/choose_aspect/invisibility_and_resistance
