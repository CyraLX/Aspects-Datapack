...
execute if score .raycastLimit aspects.essence_cage.extractor.raycast matches 1.. positioned ^ ^ ^0.1 run function aspects:essence_cage/store_essence_from_use/raycast/raycast
