advancement revoke @s only aspects:essence_cage/store_essence_from_kills/sniffer
...
scoreboard players add @s aspects.essence.plant 10
...
execute store result storage aspects:dummy stored_essences.plant int 1 run scoreboard players get @s aspects.essence.plant
