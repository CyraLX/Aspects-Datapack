advancement revoke @s only aspects:essence_cage/store_essence_from_kills/panda
...
scoreboard players add @s aspects.essence.beast 8
scoreboard players add @s aspects.essence.normal 8
