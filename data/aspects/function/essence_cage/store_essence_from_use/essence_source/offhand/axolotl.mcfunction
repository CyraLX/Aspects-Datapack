advancement revoke @s only aspects:essence_cage/store_essence_from_kills/axolotl
...
scoreboard players add @s aspects.essence.aquatic 4
scoreboard players add @s aspects.essence.normal 4
