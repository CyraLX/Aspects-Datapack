advancement revoke @s only aspects:essence_cage/store_essence_from_kills/trader_llama
...
scoreboard players add @s aspects.essence.beast 10
scoreboard players add @s aspects.essence.normal 10
...
execute store result storage aspects:dummy stored_essences.beast int 1 run scoreboard players get @s aspects.essence.beast
execute store result storage aspects:dummy stored_essences.normal int 1 run scoreboard players get @s aspects.essence.normal
