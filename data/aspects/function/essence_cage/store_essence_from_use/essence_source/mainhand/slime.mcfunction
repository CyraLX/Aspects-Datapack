advancement revoke @s only aspects:essence_cage/store_essence_from_kills/slime
...
scoreboard players add @s aspects.essence.ooze 3
...
execute store result storage aspects:dummy stored_essences.ooze int 1 run scoreboard players get @s aspects.essence.ooze
