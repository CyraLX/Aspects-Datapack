advancement revoke @s only aspects:essence_cage/store_essence_from_kills/sheep
...
scoreboard players add @s aspects.essence.beast 1
scoreboard players add @s aspects.essence.normal 1
