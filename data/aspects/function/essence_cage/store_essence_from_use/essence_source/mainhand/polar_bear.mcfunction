advancement revoke @s only aspects:essence_cage/store_essence_from_kills/polar_bear
...
scoreboard players add @s aspects.essence.ice 8
...
execute store result storage aspects:dummy stored_essences.ice int 1 run scoreboard players get @s aspects.essence.ice
