advancement revoke @s only aspects:essence_cage/store_essence_from_kills/creaking
...
scoreboard players add @s aspects.essence.dark 8
scoreboard players add @s aspects.essence.plant 8
