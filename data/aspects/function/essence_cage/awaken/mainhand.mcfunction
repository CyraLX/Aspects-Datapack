...
$item modify entity @s weapon.mainhand [{function:"minecraft:reference",name:"aspects:essence_cage/awakened_dummy"},{function:"minecraft:set_components",components:{"minecraft:item_model":"$(namespace):awakened_essence_cage",custom_data:{aspects:{awakened_essence_cage:{aspect:{namespace:"$(namespace)",name:"$(name)"}}}}}},{function:"minecraft:set_lore",entity:"this",mode:"replace_all",lore:[{translate:"item.aspects.awakened_essence_cage.stored_aspect",color:"gray",italic:0b,extra:[": ",{translate:"aspect.$(namespace).$(name)",color:"$(color)"}]},"",{translate:"item.modifiers.consume",color:"gray",italic:0b},{translate:"item.aspects.awakened_essence_cage.use_result_1",with:[{translate:"aspect.$(namespace).$(name)",color:"$(color)"}],color:"blue",italic:0b}]}]
