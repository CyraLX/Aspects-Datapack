advancement revoke @s only aspects:essence_cage/store_essence_from_kills/skeleton_horse
...
scoreboard players add @s aspects.essence.beast 12
scoreboard players add @s aspects.essence.undead 12
