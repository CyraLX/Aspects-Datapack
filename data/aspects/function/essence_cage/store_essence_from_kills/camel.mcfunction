advancement revoke @s only aspects:essence_cage/store_essence_from_kills/camel
...
scoreboard players add @s aspects.essence.beast 6
scoreboard players add @s aspects.essence.normal 6
