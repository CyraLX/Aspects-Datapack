advancement revoke @s only aspects:essence_cage/store_essence_from_kills/creeper
...
scoreboard players add @s aspects.essence.fire 3
scoreboard players add @s aspects.essence.plant 3
...
execute store result storage aspects:dummy stored_essences.fire int 1 run scoreboard players get @s aspects.essence.fire
