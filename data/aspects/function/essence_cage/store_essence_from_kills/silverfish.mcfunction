advancement revoke @s only aspects:essence_cage/store_essence_from_kills/silverfish
...
scoreboard players add @s aspects.essence.bug 2
...
execute store result storage aspects:dummy stored_essences.bug int 1 run scoreboard players get @s aspects.essence.bug
