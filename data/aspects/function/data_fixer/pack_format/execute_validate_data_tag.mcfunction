...
$execute unless data storage aspectlib:dummy aspects_pack_format_previous run data modify storage aspectlib:dummy aspects_pack_format_previous set from storage aspectlib:player_$(id) aspects.pack_format.previous
$execute unless data storage aspectlib:dummy aspects_pack_format_current run data modify storage aspectlib:dummy aspects_pack_format_current set from storage aspectlib:player_$(id) aspects.pack_format.current
