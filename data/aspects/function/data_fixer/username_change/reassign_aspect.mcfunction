...
$execute store result score #aspects aspectlib.temp run data get storage aspectlib:users player.$(id).aspectlib.player.username_changes 1
scoreboard players add #aspects aspectlib.temp 1
$execute store result storage aspectlib:users player.$(id).aspectlib.player.username_changes int 1 run scoreboard players get #aspects aspectlib.temp
