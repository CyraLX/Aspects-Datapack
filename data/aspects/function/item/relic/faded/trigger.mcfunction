...
execute unless score #aspects aspects.config.item.reward_faded_relic matches 1 run return fail
...
function aspects:item/relic/faded/prepare_aspect_for_macro with storage aspectlib:cache temp
