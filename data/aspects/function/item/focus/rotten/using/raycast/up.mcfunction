...
execute if score #aspects aspectlib.dummy matches ..0 positioned ~ ~-1 ~ run return run function aspects:item/focus/rotten/using/effects/run
# If not inside a solid block, end recursion and start effects
execute if block ~ ~ ~ #aspectlib:no_collision run return run function aspects:item/focus/rotten/using/effects/run
