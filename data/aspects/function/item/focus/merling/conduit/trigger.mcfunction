...
execute align xyz positioned ~0.5 ~0.5 ~0.5 if entity @n[type=minecraft:armor_stand,tag=aspects.merling.conduit,distance=..0.1] run return run playsound entity.ender_eye.death block @s ~ ~ ~
