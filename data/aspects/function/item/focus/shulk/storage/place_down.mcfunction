...
function aspects:item/focus/shulk/storage/get_storage_type with storage aspectlib:cache temp
function aspects:item/focus/shulk/storage/apply_data with storage aspectlib:cache temp
