...
$execute unless predicate aspectlib:input/sneak run function aspects:item/focus/honey_bee/apply_default with storage aspectlib:users player.$(id).aspects.aspect_data."aspects:honey_bee"
$execute if predicate aspectlib:input/sneak unless predicate aspects:item/focus/honey_bee/has_suspicious_honey_offhand run function aspects:item/focus/honey_bee/apply_spiked with storage aspectlib:users player.$(id).aspects.aspect_data."aspects:honey_bee"
