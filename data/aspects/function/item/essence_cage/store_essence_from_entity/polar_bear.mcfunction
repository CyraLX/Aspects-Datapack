advancement revoke @s only aspects:item/essence_cage/store_essence_from_kills/polar_bear
...
execute store result storage aspectlib:dummy stored_essences.ice int 1 run scoreboard players get @s aspects.essence.ice
