advancement revoke @s only aspects:item/essence_cage/store_essence_from_kills/allay
...
scoreboard players add @s aspects.essence.ethereal 8
scoreboard players add @s aspects.essence.flying 8
