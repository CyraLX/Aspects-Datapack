advancement revoke @s only aspects:item/essence_cage/store_essence_from_kills/creaking
...
scoreboard players add @s aspects.essence.dark 6
scoreboard players add @s aspects.essence.plant 6
