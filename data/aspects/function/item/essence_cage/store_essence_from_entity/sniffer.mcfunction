advancement revoke @s only aspects:item/essence_cage/store_essence_from_kills/sniffer
...
execute store result storage aspectlib:dummy stored_essences.plant int 1 run scoreboard players get @s aspects.essence.plant
