advancement revoke @s only aspects:item/essence_cage/store_essence_from_kills/vex
...
scoreboard players add @s aspects.essence.ethereal 6
scoreboard players add @s aspects.essence.flying 6
