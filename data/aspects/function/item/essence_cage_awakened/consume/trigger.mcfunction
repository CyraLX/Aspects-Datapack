...
data modify storage aspectlib:cache temp.aspect set from entity @s SelectedItem.components."minecraft:custom_data".aspects.awakened_essence_cage.aspect
function aspects:item/essence_cage_awakened/consume/set_aspect with storage aspectlib:cache temp.aspect
