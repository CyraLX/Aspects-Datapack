...
execute if score @s aspects.aspect_group.hydrophobic.current matches 300.. unless predicate aspects:aspect_group/hydrophobic/state/idle run return run function aspects:aspect_group/hydrophobic/logic/bossbar/state_idle with storage aspectlib:cache temp
execute unless score @s aspects.aspect_group.hydrophobic.current matches 300.. unless predicate aspects:aspect_group/hydrophobic/state/recovering run return run function aspects:aspect_group/hydrophobic/logic/bossbar/state_recovering with storage aspectlib:cache temp
