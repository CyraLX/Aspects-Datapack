...
scoreboard players operation @s aspects.aspect_group.track_hp.relative *= #aspects aspectlib.temp
...
scoreboard players operation @s aspects.aspect_group.track_hp.relative_overflow *= #aspects aspectlib.temp
...
scoreboard players operation @s aspects.aspect_group.track_hp.relative_total *= #aspects aspectlib.temp
scoreboard players operation #aspects aspectlib.temp = @s aspects.aspect_group.track_hp.maximum
scoreboard players operation #aspects aspectlib.temp += @s aspects.aspect_group.track_hp.absorption
scoreboard players operation @s aspects.aspect_group.track_hp.relative_total /= #aspects aspectlib.temp
