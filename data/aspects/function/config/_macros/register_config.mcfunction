...
data modify storage aspects:registry config append from storage aspectlib:cache temp.config
...
# Logger
function aspects:config/_macros/register_config_logger with storage aspectlib:cache temp.config
