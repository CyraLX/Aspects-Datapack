...
## From V2 to V3
execute if score #aspects aspects.config.aspectless_players_negative_effects = #aspects aspects.config.aspectless_players_negative_effects run scoreboard players operation #aspects aspects.config.player.aspectless_players_negative_effects = #aspects aspects.config.aspectless_players_negative_effects
