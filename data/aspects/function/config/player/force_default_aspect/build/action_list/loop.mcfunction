...
## Return
execute if score #aspects aspectlib.temp >= #aspects aspects.registry.aspect.list_index run return run data get storage aspectlib:registry config[{namespace:"aspects",type:"player",name:"force_default_aspect"}].dialog_data.action_list
## Recursion
