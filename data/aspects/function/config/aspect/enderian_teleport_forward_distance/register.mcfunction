...
# Default: 100
scoreboard objectives add aspects.config.aspect.enderian_teleport_forward_distance dummy
scoreboard objectives add aspects.config.aspect.enderian_teleport_forward_distance.default dummy
scoreboard objectives add aspects.config.aspect.enderian_teleport_forward_distance.min_value dummy
scoreboard objectives add aspects.config.aspect.enderian_teleport_forward_distance.max_value dummy
scoreboard objectives add aspects.config.aspect.enderian_teleport_forward_distance.advanced_inputs dummy
scoreboard players reset #aspects aspects.config.aspect.enderian_teleport_forward_distance.min_value
scoreboard players reset #aspects aspects.config.aspect.enderian_teleport_forward_distance.max_value
...
#                           Defaults to [""]
#
data modify storage aspectlib:cache temp.config set value {namespace:"aspects",type:"aspect",name:"enderian_teleport_forward_distance",dialog_type:2,dialog_data:{start:0,end:512,step:4,accepts_namespace:"aspects",accepts_name:".above_equal",accepts_with:["0"]}}
# Define Default value
scoreboard players set #aspectlib aspectlib.temp 100

# Convert legacy scoreboard
## From V2 to V3
execute if score #aspects aspects.config.enderian.teleport_forward_distance = #aspects aspects.config.enderian.teleport_forward_distance run scoreboard players operation #aspects aspects.config.aspect.enderian_teleport_forward_distance = #aspects aspects.config.enderian.teleport_forward_distance
