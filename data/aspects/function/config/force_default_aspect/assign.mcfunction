...
execute unless score #aspects aspects.config.force_default_aspect = #aspects aspects.config.force_default_aspect run return run function aspects:config/force_default_aspect/fix_value
...
function aspects:config/force_default_aspect/validate_macro with storage aspectlib:dummy
execute if score #aspects aspects.config.force_default_aspect matches ..-1 run return fail
