...
execute if score #aspects aspects.config.reward_shattered_relic matches 0 run tellraw @s {text:"",color:"#aaaaaa",extra:[{text:"",color:"#f88379",extra:["[",{translate:"aspects"},"]: "]},{text:"REWARD_SHATTERED_RELIC",color:"gold"}," was already set to ",{text:"FALSE",color:"red"}]}
execute unless score #aspects aspects.config.reward_shattered_relic matches 0 run tellraw @s {text:"",color:"#aaaaaa",extra:[{text:"",color:"#f88379",extra:["[",{translate:"aspects"},"]: "]},{text:"REWARD_SHATTERED_RELIC",color:"gold"}," is now set to ",{text:"FALSE",color:"red"}]}
# Set scoreboard
