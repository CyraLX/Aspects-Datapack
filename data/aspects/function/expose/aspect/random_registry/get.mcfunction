...
function aspects:expose/aspect/random_registry/roll with storage aspectlib:dummy
function aspects:expose/aspect/random_registry/retrieve_macro with storage aspectlib:dummy
