...
execute as @a[predicate=aspectlib:periodic_tick/100, predicate=!aspects:aspect/any, predicate=aspects:aspect/any_score] at @s run function aspects:tick/missing_aspect
# Delete unique items when held in mainhand or offhand
execute as @a[predicate=aspectlib:gamemode/survival_or_adventure, predicate=aspects:equipment/aspect_unique/mainhand] at @s run item replace entity @s weapon.mainhand with minecraft:air
execute as @a[predicate=aspectlib:gamemode/survival_or_adventure, predicate=aspects:equipment/aspect_unique/offhand] at @s run item replace entity @s weapon.offhand with minecraft:air
...
# Generic Powers
execute as @a at @s run function aspects:tick/aspect_groups
