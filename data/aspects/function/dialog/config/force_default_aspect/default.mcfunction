...
data modify storage aspectlib:data configs.aspects.force_default_aspect.current set from storage aspectlib:data configs.aspects.force_default_aspect.default
