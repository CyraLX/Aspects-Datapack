...
execute as @n[type=minecraft:armor_stand, tag=aspects_item_granter, distance=..4] run function aspects:relic/faded/apply_random_lore with storage aspectlib:dummy
