...
data modify storage aspects:registry aspect."aspects:human" set value {id: 0, namespace: "aspects", name: "human", color: "#8b7e77", shadow_color: -14541027, sound: "minecraft:entity.player.hurt"}
