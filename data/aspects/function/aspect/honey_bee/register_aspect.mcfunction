...
data modify storage aspectlib:registry aspect append value {id: 7, namespace: "aspects", name: "honey_bee", color: "#ffa41c", shadow_color: -12637945, sound: "minecraft:entity.bee.loop", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspectlib:registry aspect[{namespace: "aspects", name: "honey_bee"}]
