...
data modify storage aspects:aspect_list aspects:honey_bee set value {id: 7, namespace: "aspects", name: "honey_bee", color: "#ffa41c", sound: "minecraft:entity.cat.ambient"}
