...
data modify storage aspects:registry aspect append value {id: 1, namespace: "aspects", name: "merling", color: "#2e89f1", shadow_color: -16047556, sound: "minecraft:entity.tropical_fish.flop", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspects:registry aspect[{namespace: "aspects", name: "merling"}]
