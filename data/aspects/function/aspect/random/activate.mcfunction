...
function aspects:aspect/random/expose_aspect_registry_from_list_random_index with storage aspectlib:dummy
function aspects:aspect/activate_aspect_macro with storage aspectlib:dummy aspect_registry
