...
execute store result storage aspectlib:cache temp.movement_speed float 0.01 run scoreboard players get @s aspects.rascal.movement_speed_current
function aspects:aspect/rascal/light_level/set_attribute_macro with storage aspectlib:cache temp