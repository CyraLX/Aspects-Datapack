...
data modify storage aspects:registry aspect."aspects:rotten" set value {id: 9, namespace: "aspects", name: "rotten", color: "#3e692d", sound: "minecraft:entity.zombie.infect"}
