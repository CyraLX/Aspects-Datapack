...
# Get held item
data modify storage aspectlib:dummy item set from entity @s SelectedItem
...
function aspects:aspect/infernal/cook_food/mainhand/cook_partial with storage aspectlib:dummy item
