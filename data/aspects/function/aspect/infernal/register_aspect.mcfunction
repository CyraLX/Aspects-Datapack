...
data modify storage aspects:registry aspect append value {id: 5, namespace: "aspects", name: "infernal", color: "#ac2525", shadow_color: -13956855, sound: "minecraft:entity.blaze.ambient", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspects:registry aspect[{namespace: "aspects", name: "infernal"}]
