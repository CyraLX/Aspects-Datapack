...
data modify storage aspects:registry aspect append value {id: 4, namespace: "aspects", name: "feline", color: "#f96600", shadow_color: -12707584, sound: "minecraft:entity.cat.ambient", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspects:registry aspect[{namespace: "aspects", name: "feline"}]
