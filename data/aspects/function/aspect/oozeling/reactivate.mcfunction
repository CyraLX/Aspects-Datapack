...
data modify storage aspectlib:cache temp.aspect set from storage aspectlib:registry aspect[{namespace: "aspects", name: "oozeling"}]
...
## Initialize Amplify Elasticity
function aspects:item/focus/oozeling/amplify_elasticity/bossbar/initialize