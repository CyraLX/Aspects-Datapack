...
data modify storage aspectlib:registry aspect append value {id: 6, namespace: "aspects", name: "elytrian", color: "#f2f10d", shadow_color: -12829693, sound: "minecraft:entity.parrot.ambient", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspectlib:registry aspect[{namespace: "aspects", name: "elytrian"}]
