execute unless predicate aspects:aspect/elytrian/advancement/flying_marathon/should_increase if score @s aspects.elytrian.advancements.flying_marathon.distance_traveled matches 1.. run return run function aspects:aspect/elytrian/advancement/flying_marathon/cancel_tracking
