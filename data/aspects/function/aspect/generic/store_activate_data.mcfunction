...
$execute unless data storage aspectlib:dummy old_aspect run data modify storage aspectlib:dummy old_aspect set from storage aspectlib:users player.$(id).aspects.previous_aspect
