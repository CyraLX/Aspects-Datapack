...
execute if block ~ ~ ~ #aspectlib:raycast/pass_through if score .raycastLimit aspects.focus.enderian.raycast.forward matches 1.. positioned ^ ^ ^0.25 run function aspects:focus/enderian/raycast/forward
