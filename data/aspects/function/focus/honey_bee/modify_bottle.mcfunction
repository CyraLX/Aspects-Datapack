...
$execute unless predicate aspectlib:input/sneak run function aspects:focus/honey_bee/apply_default with storage aspectlib:player_$(id) aspects.aspect_data.honey_bee
$execute if predicate aspectlib:input/sneak unless predicate aspects:focus/honey_bee/has_suspicious_honey_offhand run function aspects:focus/honey_bee/apply_spiked with storage aspectlib:player_$(id) aspects.aspect_data.honey_bee
$execute if predicate aspectlib:input/sneak if predicate aspects:focus/honey_bee/has_suspicious_honey_offhand run function aspects:focus/honey_bee/apply_spiked_fake with storage aspectlib:player_$(id) aspects.aspect_data.honey_bee
